import { HStack, Stack, Text,Tag, Icon, Button ,Flex, Image,Tab, Tabs, TabList, TabPanels, TabPanel} from "@chakra-ui/react"
    ...
    <CustomCard>
        ...
        <Stack>
            <HStack color="black.80">
                <Text fontSize="
                sm">Wallet Balances</Text>
            </HStack>
            <HStack spacing={2} align={{
      base:"flex-start",
      lg:"center",
    }}
    flexDir={{
            ...
            <HStack>
            <Text textStyle="h2" fontWeight="medium">22.34401000</Text> 
